...
CREATE TABLE `users` (
  ...
  `Passwords` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
ALTER TABLE `student_semester`
  MODIFY `SemesterID` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `subjects_section_detail`
  MODIFY `Subjects_Section_DetailID` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `examscheduledetail`
  ADD CONSTRAINT `examscheduledetail_ibfk_1` FOREIGN KEY (`Exam_ID`) REFERENCES `student` (`StudentID`) ON DELETE CASCADE ON UPDATE CASCADE,
